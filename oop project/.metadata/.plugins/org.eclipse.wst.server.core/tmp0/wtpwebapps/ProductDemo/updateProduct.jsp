    ...
    <div class="container">
        ...
        <form id="productForm" action="update" method="post">
            ...
            <div class="input-group">
                ...
                <input type="text" id="category" name="abcd" placeholder="Enter price" value="<%= category %>" readonly>
            ...
            <button type="submit" name="submit" onclick="validateForm()">Update Product</button>
        </form>
    </div>
